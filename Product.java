...
public class Product {
    ...
    public void displayProduct(){
        System.out.printf("%5s %17s %14s %17s\n" ,id, productName, price, quantity);
    }
    /*
     Creating arraylist with datatype Product which is a constructor so we dont have to initialize object everytime and also
    ...
    ArrayList<Product> products = new ArrayList<>();
        ...
        products.add(new Product("5", "Batteries", 50, 5));
